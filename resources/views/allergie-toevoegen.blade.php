    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div class="flex items-center gap-8">
                <h2 class="text-xl font-bold text-orange-700">Allergie Toevoegen</h2>
    ...
    <div class="py-10">
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white rounded-2xl shadow-lg p-8 border border-orange-100">
                ...
                <h1 class="text-3xl font-bold text-gray-900 mb-3">Nieuwe allergie registreren.</h1>
                <p class="text-gray-600 mb-6">
                    Voeg hier een nieuwe allergie toe aan de tabel <code class="bg-gray-100 px-2 py-1 rounded text-sm">Allergie</code>.
                ...
                <form method="post" action="{{ route('allergie.toevoegen') }}" class="space-y-6">
                    @csrf
                    ...
                    <div>
                        ...
                        <select id="ernst" name="ernst" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition">
                            ...
                            <option value="Laag" {{ old('ernst') === 'Laag' ? 'selected' : '' }}>Laag</option>
                            <option value="Gemiddeld" {{ old('ernst') === 'Gemiddeld' ? 'selected' : '' }}>Gemiddeld</option>
                            <option value="Hoog" {{ old('ernst') === 'Hoog' ? 'selected' : '' }}>Hoog</option>
                        </select>
                    </div>
