    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div class="flex items-center gap-8">
                <h2 class="text-xl font-bold text-orange-700">Leverancier Toevoegen</h2>
    ...
    <div class="py-10">
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white rounded-2xl shadow-lg p-8 border border-orange-100">
                ...
                <h1 class="text-3xl font-bold text-gray-900 mb-3">Nieuwe leverancier toevoegen</h1>
                <p class="text-gray-600 mb-6">
                    Voeg een nieuwe leverancier toe aan het systeem. Vul alle verplichte velden in.
                </p>
