    ...
    <nav class="admin-navbar">
        <div class="admin-navbar-inner">
            <div class="admin-left">
                <a href="<?php echo e(route('leveranciers.index')); ?>" class="admin-logo-link">
                ...
                <div class="admin-desktop-links">
                    ...
                    <a href="<?php echo e(route('leveranciers.index')); ?>" class="nav-link nav-link-active">Leveranciers</a>
                </div>
            </div>
...
</html><?php /**PATH C:\Voedselbank-Maaskantje\example-app\resources\views/layouts/app.blade.php ENDPATH**/ ?>