...
CREATE TABLE Klant (
    ...
    CONSTRAINT FK_Klant_Inlog FOREIGN KEY (Inlog_Id) REFERENCES Inlog(Id)
);
...
CREATE TABLE Voorraad (
    ...
    CONSTRAINT FK_Voorraad_Leverancier FOREIGN KEY (Leverancier_Id) REFERENCES Leverancier(Id)
);
...
CREATE TABLE Voedselpakket (
    ...
    CONSTRAINT FK_Voedselpakket_Klant FOREIGN KEY (Klant_Id) REFERENCES Klant(Id)
);
...
CREATE TABLE Voedselpakket_item (
    ...
    Aantal INT NOT NULL,
    CONSTRAINT FK_VoedselpakketItem_Voedselpakket FOREIGN KEY (Voedselpakket_Id) REFERENCES Voedselpakket(Id),
    CONSTRAINT FK_VoedselpakketItem_Voorraad FOREIGN KEY (Voorraad_Id) REFERENCES Voorraad(Id)
);
...
CREATE TABLE Klant_Allergie (
    ...
    CONSTRAINT FK_KlantAllergie_Klant FOREIGN KEY (Klant_Id) REFERENCES Klant(Id),
    CONSTRAINT FK_KlantAllergie_Allergie FOREIGN KEY (Allergie_Id) REFERENCES Allergie(Id)
);
...
CREATE TABLE Admin (
    ...
    Naam VARCHAR(100) NOT NULL,
    Email VARCHAR(100) NOT NULL UNIQUE,
    CONSTRAINT FK_Admin_Inlog FOREIGN KEY (Inlog_Id) REFERENCES Inlog(Id)
);

-- Admin account aanmaken (wachtwoord: password)
INSERT INTO Inlog (Email, Wachtwoord, Rol) VALUES (
    'admin@voedselbank.nl',
    '$2y$12$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi',
    'admin'
);

INSERT INTO Admin (Inlog_Id, Naam, Email) VALUES (
    1,
    'Beheerder',
    'admin@voedselbank.nl'
);
